...
class TextGeneration:
    def __init__(self):
        ...
        self.logo_frame = "asset/frame/logo1.png"
        self.chef_frames = {
...
def main():
    ...
    with col2:
        st.image(load_image_from_local("asset/images/logo1.png"), width=400)
    ...
    with col1:
        ...
        st.markdown(
            ...
            <style>
            .stApp {{
                background-image:url("https://img.freepik.com/free-photo/vintage-old-rustic-cutlery-dark_1220-4886.jpg?w=1060&t=st=1677733466~exp=1677734066~hmac=62f26c5e87475d3c41ccc9aba7f9d0e8de1f1631e10003b7e979948605625277");
